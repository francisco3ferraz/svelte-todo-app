	...
	<div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
		<form method="post">
			<div class="grid gap-6 mb-6 md:grid-cols-2">
				<div>
					<label for="first_name" id="first_name" class="block mb-2 text-sm font-medium text-gray-900">First name</label>
				...
				<div>
					<label for="last_name" id="last_name" class="block mb-2 text-sm font-medium text-gray-900">Last name</label>
			...
			<div class="mb-6">
				...
				<input type="password" name="conf_password" id="confirm_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="•••••••••" required>
			</div> 
			<button type="submit" class="text-white bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
		</form>

		<p class="mt-10 text-center text-sm text-gray-500">
			Already a member?
			<a href="/signin" class="font-semibold leading-6 text-orange-600 hover:text-orange-500"
				>Sign in</a
			>
		</p>
	</div>
